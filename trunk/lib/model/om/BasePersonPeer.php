...
/**
 * Base static class for performing query and update operations on the 'tln_person' table.
 *
 * 
 *
 * This class was autogenerated by Propel 1.3.0-dev on:
 *
 * Mon Jan 26 23:50:42 2009
 *
...
abstract class BasePersonPeer {
	...
	const ID = 'tln_person.ID';

	/** the column name for the FIRST field */
	const FIRST = 'tln_person.FIRST';

	/** the column name for the LAST field */
	const LAST = 'tln_person.LAST';

	/** the column name for the NICKNAME field */
	const NICKNAME = 'tln_person.NICKNAME';

	/** the column name for the IMAGE_NAME field */
	const IMAGE_NAME = 'tln_person.IMAGE_NAME';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'tln_person.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'tln_person.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'First', 'Last', 'Nickname', 'ImageName', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'first', 'last', 'nickname', 'imageName', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FIRST, self::LAST, self::NICKNAME, self::IMAGE_NAME, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'first', 'last', 'nickname', 'image_name', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'First' => 1, 'Last' => 2, 'Nickname' => 3, 'ImageName' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'first' => 1, 'last' => 2, 'nickname' => 3, 'imageName' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FIRST => 1, self::LAST => 2, self::NICKNAME => 3, self::IMAGE_NAME => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'first' => 1, 'last' => 2, 'nickname' => 3, 'image_name' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PersonPeer::FIRST);

		$criteria->addSelectColumn(PersonPeer::LAST);

		$criteria->addSelectColumn(PersonPeer::NICKNAME);

		$criteria->addSelectColumn(PersonPeer::IMAGE_NAME);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the tln_person table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
