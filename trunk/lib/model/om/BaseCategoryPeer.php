...
/**
 * Base static class for performing query and update operations on the 'tln_category' table.
 *
 * 
 *
...
abstract class BaseCategoryPeer {
	...
	const ID = 'tln_category.ID';

	/** the column name for the NAME field */
	const NAME = 'tln_category.NAME';
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the tln_category table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
