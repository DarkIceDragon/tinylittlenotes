...
/**
 * Base class that represents a row from the 'tln_person' table.
 *
 * 
 *
...
abstract class BasePerson extends BaseObject  implements Persistent {
  ...
  const PEER = 'PersonPeer';
	...
	public function setFirst($v)
	{
		...
		if ($this->first !== $v) {
			$this->first = $v;
			$this->modifiedColumns[] = PersonPeer::FIRST;
		}
	...
	public function setLast($v)
	{
		...
		if ($this->last !== $v) {
			$this->last = $v;
			$this->modifiedColumns[] = PersonPeer::LAST;
		}
	...
	public function setImageName($v)
	{
		...
		if ($this->image_name !== $v) {
			$this->image_name = $v;
			$this->modifiedColumns[] = PersonPeer::IMAGE_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->image_name = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setImageName($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PersonPeer::FIRST)) $criteria->add(PersonPeer::FIRST, $this->first);
		if ($this->isColumnModified(PersonPeer::LAST)) $criteria->add(PersonPeer::LAST, $this->last);
		if ($this->isColumnModified(PersonPeer::NICKNAME)) $criteria->add(PersonPeer::NICKNAME, $this->nickname);
		if ($this->isColumnModified(PersonPeer::IMAGE_NAME)) $criteria->add(PersonPeer::IMAGE_NAME, $this->image_name);
